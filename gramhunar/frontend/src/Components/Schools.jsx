  ...
  return (
    <>
      ...
      <div className="container flex justify-center gap-4 mt-5 flex-wrap">
        {schools.map((school) => {
          return (
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow  " key={school.schoolId}>
              <a href="#">
                <img
                  class="rounded-t-lg"
              ...
              <div class="p-5">
                <a href="#">
                  <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">{school.schoolName}</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 "></p>
                <Link
                  onClick={() => {
                    localStorage.setItem("school", school.schoolId);
                  }}
